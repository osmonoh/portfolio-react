            ...
            <article className="project">
              <div className="project-text">
                ...
                <p className="project-text-proper">
                  ...
                  allows to search for videos as well as play them. It also
                  offers the option to toggle between light and dark mode. It
                  makes use of a promise-based HTTP client Axios to interact
            ...
            <article className="project">
              <div className="project-text">
                ...
                <p className="project-text-proper">
                  ...
                  with frontend page introducing the API, offering some
                  interactive examples of requests and responses, as well as
                  documentation. Its name is decentAPI and it is deployed on
                  Heroku. These are some of the technologies and approaches
            ...
            <article className="project">
              <div className="project-text">
                ...
                <p className="project-text-proper">
                  ...
                  create a version of the Bulls and Cows game to be played in
                  the terminal. Finishing the task in a very good time I decided
                  to challenge myself further and took it to the browser making
                  it my first ever DOM manipulation project. I went on this one
                  completely vanilla.
                </p>
                <p className="project-text-keywords">
            ...
            <article className="project">
              <div className="project-text">
                ...
                <div className="project-text-proper">
                  <p>
                    This is a group full-stack project of five people. We
                    created a platform where a person offering a pet can connect
                    with a person who wants to adopt one smooth, easy and fast.
                    Users can chat in real-time. This is a full-stack project:
                  </p>
                  <p>
